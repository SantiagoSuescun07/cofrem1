...
import { useCreateComment } from "@/mutation/news"; // Using same mutation as news
...
interface PublicationCommentFormProps {
  nid: number;
}

export function PublicationCommentForm({ nid }: PublicationCommentFormProps) {
  ...
  const handleSubmit = async (data: CommentFormData) => {
    try {
      ...
      // Refetch comments for the specific publication item
