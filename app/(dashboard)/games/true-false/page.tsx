...
import { TrueFalseGameDetails } from "@/types/games";
...
export default function TrueFalsePage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Verdadero o Falso..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--true_false_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <TrueFalseGame
        gameDetails={gameDetails as TrueFalseGameDetails}
