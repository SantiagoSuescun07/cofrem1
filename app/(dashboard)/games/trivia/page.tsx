...
import { TriviaGameDetails } from "@/types/games";
...
export default function TriviaPage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Trivia..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--trivia_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <TriviaGame
        gameDetails={gameDetails as TriviaGameDetails}
