...
export default function CompletePhrasePage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Completa la Frase..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--complete_phrase_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <CompletePhraseGame
        gameDetails={gameDetails as CompletePhraseGameDetails}
