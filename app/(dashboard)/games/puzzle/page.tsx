...
export default function PuzzlePage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Rompecabezas..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--puzzle_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <PuzzleGame
        gameDetails={gameDetails as PuzzleGameDetails}
