...
import { WordMatchGameDetails } from "@/types/games";
...
export default function WordMatchPage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Emparejar Palabras..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--word_match_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <WordMatchGame
        gameDetails={gameDetails as WordMatchGameDetails}
