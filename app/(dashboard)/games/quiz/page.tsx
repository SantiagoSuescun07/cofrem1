...
import { QuizGameDetails } from "@/types/games";
...
export default function QuizPage() {
  ...
  if (campaignsLoading || gameLoading) {
    return <GameLoader message="Cargando Quiz..." />;
  }

  if (!campaign || !gameDetails || gameDetails.type !== "paragraph--quiz_game") {
    return (
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 md:px-10 py-6">
      ...
      <QuizGame
        gameDetails={gameDetails as QuizGameDetails}
